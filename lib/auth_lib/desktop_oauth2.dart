...
import 'package:ciy_client/auth_lib/desktop_const.dart';
...
class DesktopOAuth2 {
  ...
  Future<Map<String, dynamic>?> reAuthorize(
    ...
    final response = await http.post(Uri.parse(reAuthUrl),
        body: tokenReqPayload, headers: headers);
